...
- `kawase_blur` and rounded borders are NOT available in latest picom release (v8.2), consider using other forks like [ibhagwan/picom](https://github.com/ibhagwan/picom).
